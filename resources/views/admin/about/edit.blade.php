        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('about.update', $post->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <strong>{{ __('main.children_number') }}</strong>
                                    <input type="text" name="static" class="form-control" value="{{ $post->static  }}"
                                           placeholder="">
                                </div>
                            </div>
                            <input  type="hidden" name="category" class="hidden" value="{{ $post->category_id  }}"
                                   placeholder="">
