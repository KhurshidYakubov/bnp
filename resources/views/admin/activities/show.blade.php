            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ __('main.activities') }} {{ $post_view->id }}</h1>
                        <form action="{{ route('activities.destroy', $post_view->id) }}" method="POST">
                            ...
                            <a href="{{ route('activities.edit', $post_view->id) }}"
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td>{{ __('main.experience') }}:</td>
                            <th scope="row">{{ $post_view->definition ?? __('main.not_set')}}</th>
                        </tr>
