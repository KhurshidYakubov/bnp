        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('pages.update', $post->id) }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="tab-content" id="myTabContent">
                            <div class="tab-pane fade show active" id="oz" role="tabpanel" aria-labelledby="home-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('oz_description') ? 'is-invalid' : '' }}"
                                           type="text" name="oz_description" id="oz_description"
                                           value="{{ $post->translate('oz')->description ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('main.body') }} | O'z</label>
                                    <textarea class="form-control {{ $errors->has('oz_body') ? 'is-invalid' : '' }}"
                                              name="oz_body" id="editor_oz"
                                              >{!!  $post->translate('oz')->body !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="uz" role="tabpanel" aria-labelledby="profile-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('uz_description') ? 'is-invalid' : '' }}"
                                           type="text" name="uz_description" id="uz_description"
                                           value="{{ $post->translate('uz')->description ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('main.body') }} | Уз</label>
                                    <textarea class="form-control {{ $errors->has('uz_body') ? 'is-invalid' : '' }}"
                                              name="uz_body" id="editor_uz"
                                              >{!!  $post->translate('uz')->body ?? '' !!}</textarea>
                                </div>
                            </div>
                            ...
                            <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control {{ $errors->has('ru_description') ? 'is-invalid' : '' }}"
                                           type="text" name="ru_description" id="ru_description"
                                           value="{{ $post->translate('ru')->description ?? '' }}">
                                </div>
                                <div class="form-group">
                                    <label>{{ __('main.body') }} | Ру</label>
                                    <textarea class="form-control {{ $errors->has('ru_body') ? 'is-invalid' : '' }}"
                                              name="ru_body" id="editor_ru"
                                             >{!! $post->translate('ru')->body ?? '' !!}</textarea>
                                </div>
                            </div>
                        </div>
                        <div class="row">
