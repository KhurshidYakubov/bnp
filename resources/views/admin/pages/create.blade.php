                    ...
                    <form action="{{ route('pages.store') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                        ...
                        <div class="tab-content" id="myTabContent">
                            ...
                            <div class="tab-pane fade" id="ru" role="tabpanel" aria-labelledby="contact-tab">
                                ...
                                <div class="form-group">
                                    <label class="required" for="ru_description">{{ __('main.short_desc') }} | Ру</label>
