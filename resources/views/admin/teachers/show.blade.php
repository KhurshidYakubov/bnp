            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">{{ __('main.teachers') }} {{ $post_view->id }}</h1>
                        <form action="{{ route('teachers.destroy', $post_view->id) }}" method="POST">
                            ...
                            <a href="{{ route('teachers.edit', $post_view->id) }}"
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="oz" role="tabpanel" aria-labelledby="home-tab">
                            <table class="table table-striped table-hover">
                                <tbody>
                                <tr>
                                    <td>{{ __('main.teachers_position') }}:</td>
                                    <th scope="row">{{ $post_view->translate('oz')->title ?? '' }}</th>
                                </tr>
                                <tr>
                                    <td>{{ __('main.teachers_name') }}:</td>
                    ...
                    <table class="table table-striped table-hover">
                        ...
                        <tr>
                            <td>{{ __('main.order') }}:</td>
                            <th scope="row">{{ $post_view->link ?? '' }}</th>
                        </tr>
                        <tr>
                            <td>{{ __('main.image') }}:</td>
                            <th scope="row">
