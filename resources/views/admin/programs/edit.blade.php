        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('programs.update', $post->id) }}" method="POST" enctype="multipart/form-data"
                          autocomplete="off">
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
                                    <strong>{{ __('main.age') }}</strong>
                                    <input class="form-control" type="text" name="static" value="{{ $post->static }}">
                                </div>
                            </div>
                            <div class="col-xs-6 col-sm-6 col-md-6">
                                <div class="form-group">
